            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('register')); ?>" aria-label="<?php echo e(__('Register')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('username') ? ' has-error' : ''); ?> row">
                            ...
                            <div class="col-md-6">
                                ...
                                <?php if($errors->has('username')): ?> <span class="help-block">
                                    <strong><?php echo e($errors->first('username')); ?></strong> </span>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="address" class="form-control<?php echo e($errors->has('address') ? ' is-invalid' : ''); ?>" name="address" cols="50" rows="5" required><?php echo e(''); ?></textarea>
